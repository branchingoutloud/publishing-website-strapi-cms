    ...
    async find(ctx) {
        ...
        const transformedData = data.map(product => ({
            ...
            pros_and_cons: {
                ...
                pros:  ["Real-time collaboration", "Robust integrations", "User-friendly interface", "Scalable", "Cost-effective", "Cross-platform", "Secure", "Customizable", "Easy to use", "Fast"],
                cons_summary: this.extractSummaryPoints(product.cons), 
                cons: ["Difficult to use", "Expensive", "Not secure", "Not customizable", "Not scalable", "Not cross-platform", "Not robust", "Not fast", "Not easy to use", "Not cost-effective"]
            }
        }));
