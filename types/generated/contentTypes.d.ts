...
export interface ApiComparisonFeatureComparisonFeature
  extends Struct.CollectionTypeSchema {
  collectionName: 'comparison_features';
  info: {
    displayName: 'Comparison feature';
    pluralName: 'comparison-features';
    singularName: 'comparison-feature';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::comparison-feature.comparison-feature'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    product_feature_values: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-feature-value.product-feature-value'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProductFeatureValueProductFeatureValue
  extends Struct.CollectionTypeSchema {
  collectionName: 'product_feature_values';
  info: {
    displayName: 'Product feature value';
    pluralName: 'product-feature-values';
    singularName: 'product-feature-value';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    feature_id: Schema.Attribute.Relation<
      'manyToOne',
      'api::comparison-feature.comparison-feature'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    average_stars: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 5;
          min: 0;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::comparison-feature.comparison-feature': ApiComparisonFeatureComparisonFeature;
      'api::product-feature-value.product-feature-value': ApiProductFeatureValueProductFeatureValue;
